...
SSA — ключевое свойство современных IR. В SSA каждая переменная определяется ровно один раз. При слиянии потоков управления используется специальная инструкция **phi** (φ-функция).

...
Масштаб и поворот — линейные преобразования, которые выражаются матрицей 3×3:
...
Но перенос — это НЕ линейное преобразование. Его нельзя выразить матрицей 3×3:
...
Нет матрицы 3×3, такой что M × [x,y,z]ᵀ = [x+tx, y+ty, z+tz]ᵀ для произвольных tx, ty, tz.
...
Теперь перенос выражается матрицей 4×4:
...
2. **Матрицы 4×4** объединяют все аффинные трансформации в единый формат

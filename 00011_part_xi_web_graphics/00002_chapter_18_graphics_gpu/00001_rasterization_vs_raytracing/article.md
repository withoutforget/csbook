...
Наивная ray tracing для сцены с 1 миллионом треугольников: каждый луч проверяет 1 миллион треугольников. Это O(n) на луч. Для экрана 1920×1080 = 2 миллиона пикселей — это 2×10¹² операций в секунду. Катастрофически медленно.

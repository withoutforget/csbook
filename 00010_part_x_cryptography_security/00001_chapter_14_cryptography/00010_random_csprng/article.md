...
MT имеет состояние $624 \times 32$-битных слов. После наблюдения 624 последовательных выходов можно восстановить полное состояние:
...
1. **Next-bit unpredictability:** зная любое количество предыдущих битов, вычислительно нереализуемо предсказать следующий бит с вероятностью > $50\% + \varepsilon$

...
Для 64-битного адресного пространства (2^64 = 18 экзабайт) страничная таблица размером 2^52 записей $\times$ 8 байт = 32 ПБ — нереально.
...
Каждый уровень — 512 записей $\times$ 8 байт = 4 KB (одна страница).

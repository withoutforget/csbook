...
Алгоритм банкира применяется в СУБД и планировщиках реального времени. В общем случае он полиномиальный ($O(n^2 m)$), что приемлемо при небольшом числе ресурсов.

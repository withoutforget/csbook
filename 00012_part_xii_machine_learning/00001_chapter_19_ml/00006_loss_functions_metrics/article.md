...
Focal Loss (Lin et al., RetinaNet 2017) — модификация BCE для сильно несбалансированных задач (например, детекция объектов, где фон $\gg$ объекты):
...
|---|---|---|
| Регрессия (нет выбросов) | MSE, $R^2$ | Нормальные данные |
